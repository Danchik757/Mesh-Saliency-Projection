...
| Smooth gaze / GT (per-model) | `/Users/admin/Documents/LAB/SALIENCY_code/GAZE_DATA/datasets/SAL3D/SAL3D_Dataset/Smooth_Gaze/` |
...
- Smooth Gaze: `<model>_neighbors.txt` (smoothed GT)
