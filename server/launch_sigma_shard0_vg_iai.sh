#!/usr/bin/env bash
# rc3 sigma sweep stage-1 — shard 0 of 3 — vg-iai
#
# Shard:   0 / 3  (464 jobs of 1400 total)
# Workers: 32
# Session: rc3_sigma_shard0
#
...
#   bash server/launch_sigma_shard0_vg_iai.sh
#
...
echo "[launch] server:      vg-iai"
echo "[launch] session:     ${SESSION}"
echo "[launch] run_id:      ${RUN_ID}"
echo "[launch] shard:       ${SHARD_INDEX} / ${NUM_SHARDS}  (464 of 1400 total)"
