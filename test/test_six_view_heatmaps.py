...
class TestLoadAndPrepareMap:
    ...
    def test_face_domain_detected(self, tmp_path):
        ...
        _, _, _, domain, _, _ = load_and_prepare_map(p, n_verts=10, n_faces=n_f,
                                                      faces=faces)
        assert domain == "face"
    ...
    def test_vertex_domain_detected(self, tmp_path):
        ...
        faces = np.zeros((n_f, 3), dtype=np.int32)
        _, _, _, domain, _, _ = load_and_prepare_map(p, n_verts=n_v, n_faces=n_f,
                                                      faces=faces)
    ...
    def test_constant_map_all_zero(self, tmp_path):
        ...
        faces = np.zeros((n_f, 3), dtype=np.int32)
        vals01, _, _, _, constant_map, warning = load_and_prepare_map(
            p, n_verts=10, n_faces=n_f, faces=faces
        )
    ...
    def test_vertex_to_face_mean(self, tmp_path):
        ...
        vals01, vmin, vmax, domain, _, _ = load_and_prepare_map(
...
class TestResolveMapPaths:
    ...
    def test_sal3d_screen_space_path(self, tmp_path):
        ...
        paths = resolve_map_paths("sal3d", mr, dr, "bunny", None, gt_dir,
                                  ["screen_space"])
    ...
    def test_sal3d_cone_path(self, tmp_path):
        ...
        paths = resolve_map_paths("sal3d", mr, dr, "dragon", None, gt_dir,
                                  ["cone"])
    ...
    def test_sal3d_gt_path(self, tmp_path):
        ...
        paths = resolve_map_paths("sal3d", mr, dr, "turbine", None, gt_dir,
                                  ["gt"])
    ...
    def test_sal3d_gt_none_when_no_fixed_gt_dir(self, tmp_path):
        ...
        paths = resolve_map_paths("sal3d", mr, dr, "bunny", None, None,
                                  ["gt"])
    ...
    def test_sal3d_missing_file_returns_none(self, tmp_path):
        ...
        paths = resolve_map_paths("sal3d", mr, dr, "bunny", None, gt_dir,
                                  ["screen_space", "cone"])
        # bunny exists but "ghost" does not
        paths2 = resolve_map_paths("sal3d", mr, dr, "ghost", None, gt_dir,
                                   ["screen_space"])
