...
echo "[run_meshmamba_baseline_cone] recenter=${RECENTER_TO_BBOX_CENTER}  base_rotate_z=${BASE_ROTATE_Z_DEG}  extra_rotate_x=${EXTRA_ROTATE_X_DEG}  override_fov=${OVERRIDE_FOV_DEG:-<from_json>}  projection_fov_mode=${PROJECTION_FOV_MODE}  transform_order=${TRANSFORM_ORDER}"
