#!/usr/bin/env bash
# Pack MeshMamba_non_texture participant CSV side inputs into a tar.gz archive for scp transfer.
...
#   jsons/object_placement/mamba_non_jsons
...
ls -lh "${LOCAL_PACK_DIR}/meshmamba_non_texture_csv.tar.gz"
...
echo "  \${REPO_ROOT}/jsons/object_placement/mamba_non_jsons"
