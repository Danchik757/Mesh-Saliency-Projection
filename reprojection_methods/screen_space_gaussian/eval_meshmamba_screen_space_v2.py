...
# Density image resolution — full 1920×1080 to match Saliency3D_clear validated baseline.
# Sigma is specified in absolute pixels at this resolution (default 26.3 px).
_IMG_W = 1920
_IMG_H = 1080
...
def main() -> None:
    ...
    tag_parts = [f"sigmapx{args.sigma_px}".replace(".", "p")]
